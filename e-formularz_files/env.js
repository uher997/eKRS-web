(function(window) {
  ...
  window['env']['portalUrl'] = "https://prs.ms.gov.pl";
  window["env"]["prsSlownikiApiUrl"] = "/api/slowniki/";
  window["env"]["ePlatnosciApiUrl"] = "https://oplaty.ms.gov.pl/e-usluga";
  window["env"]["paymentDelay"] = "1000";
  window["env"]["paymentRepeatAmount"] = "5";
  window["env"]["ekrsApiUrl"] = "/api/eKRS/";
  window["env"]["mfkAdminApiUrl"] = "/api/mfkAdmin/";
  window["env"]["apkZewUrl"] = "https://prs-gui-zew-prs-prod.apps.ocp.prod.ms.gov.pl/";
  window["env"]["prsApiUrl"] = "/api/prs/";
  window["env"]["terytApiUrl"] = "/api/teryt/";
  ...
  window["env"]["tokenCheckTime"] = "300000";
  window["env"]["refreshToken"] = "";
  ...
  window['env']['pokazWersjeRobocze'] = "",
  window['env']['pokazWyszukiwarkePortal'] = ""
  window['env']['baeFormActive'] = "false";
})(this);
